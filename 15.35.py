...
class SierpinskiTriangle:
    ...
    def drawPoly(self, p1, p2, p3):
        if self.fill != False:
            self.canvas.create_polygon(p1[0], p1[1], p2[0], p2[1], p3[0], p3[1], fill = "black", tags = "line")
            self.fill = True
        else:
            self.canvas.create_polygon(p1[0], p1[1], p2[0], p2[1], p3[0], p3[1], fill = "white", tags = "line")
            self.fill = False
