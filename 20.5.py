...
from AVLTree20_5 import AVLTree
...
def displayTree(root, x, y, hGap):
    ...
    canvas.create_text(x, y + 10, text = "BF: "+ str(tree.balanceFactor(root)), tags = "tree")
...
Button(frame1, text = "Search", command = search).pack(side = LEFT)
