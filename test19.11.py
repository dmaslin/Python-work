from binarytree19_11 import BinaryTree
...
print("\nThe number of non-leaf nodes is "+ str(tree.nonLeafNodes()), end = "")
print("\nThe numbers in order is ", end = "")
for i in range(tree.getSize()):
    print(next(tree), end = " " )
# Search for an element
print("\nIs Peter in the tree? " + str(tree.search("Peter")))
