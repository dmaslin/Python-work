...
def ordered():
    tkinter.messagebox.showinfo("Inorder", tree.inorder())
def pordered():
    tkinter.messagebox.showinfo("Preorder", tree.preorder())
def post():
    tkinter.messagebox.showinfo("Postorder", tree.postorder())
...
Button(frame1, text = "Show Inorder", command = ordered).pack(side = LEFT)
Button(frame1, text = "Show Preorder", command = pordered).pack(side = LEFT)
Button(frame1, text = "Show Postorder", command = post).pack(side = LEFT)
